...
- Men onderscheidt:
	...
	- <span style="color:#c8ab83;">Multicast</span>: gebruikt om meerdere interfacen een zelfde adres te geven. Data gestuurd naar dit adres wordt ontvangen door iedereen met dit adres
	- <span style="color:#c8ab83;">Anycast</span>: gebruikt wanneer een host gegevens wil versturen naar een andere host van een **bepaald type**, maar het daarbij niet uitmaakt *welke* 