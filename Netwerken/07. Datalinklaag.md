...
- <span style="color:#c8ab83;">Unreliable (niet betrouwbaar)</span>: Ontvanger stuurt geen bevestigigen van goede ontvangst
...
- Ethernet en CSMA/CD
	...
	- <span style="color:#c8ab83;">collission detection</span>: Ontvangende NIC breekt de communicatie af wanneer een botsing op de lijn wordt gede