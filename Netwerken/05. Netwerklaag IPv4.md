...
- Het <span style="color:#c8ab83;">local broadcast-adres</span> is een bijzonder adres dat kan gebruikt worden om data te sturen naar al de netwerkinterfaces die verbonden zijn met dezelfde routerpoort als de z