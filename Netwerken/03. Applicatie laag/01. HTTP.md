...
Met de <span style="color:#c8ab83;">POST</span>-Methode kan een client gegevens naar de server sturen, vb. wanneer een formulier wordt ingediend. POST-verzoeken worden vaak gebruikt voor het maken of bi