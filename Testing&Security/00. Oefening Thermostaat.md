...
4. Test 0: Build slaagt met werkende klassen en interfaces (zie klassediagram). Klasse `Thermostat` wordt geïnstantieerd vanui methode `main (program.cs)`. De loop wordt ook toegevoegd (kan later
	...
	HS | Step 4 | Application Structure ([github stap](https://github.com/janvandenpoelatAP/HeaterSystem/commit/ec671dd71ff94929b1493af37cde3d58f94dc9aa#diff-eece539313e5128d728a07051fcf86f69265fefe8fed45341f76ee9e206b9f41))
#### HeatingElement.cs
```cs
...
HS | Commit 4 | Add properties Setpoint and Offset ( [github stap](https://github.com/janvandenpoelatAP/HeaterSystem/commit/47b4fae1eddfeba73bcd7f35abddbc090a8d4452) ) 