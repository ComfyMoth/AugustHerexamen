...
De OpenWeather API wil ik niet in mijn testen gebruiken. De API kan offline zijn, of er kan (vb.) een probleem met het netwerk zijn. Ik gebruik `Mockoon`. Ik test dus het sturen van de request naar de API e