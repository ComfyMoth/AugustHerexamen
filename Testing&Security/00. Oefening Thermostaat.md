...
2. Voeg aan de solution een testproject `HeaterSystem.UnitTests` toe (`MSTest`). Vergeet niet je referentie naar het console project te leggen. Build een eerste keer.