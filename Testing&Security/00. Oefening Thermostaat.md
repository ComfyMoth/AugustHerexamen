...
<span style="color:#48cae4;">HS | Commit 19 | WorkWhenInSafeModeAndTemperatureSuccessResest Test 8</span>
Schrijf dan de code om de test te laten slagen
<span style="color:#48cae4;">HS | Commit 20 | Implementatie test 8</span>

## Stap 4: Integratie testen
1. Tot nu toe hebben we het ophalen van de temperatuur 'gemocked'. Er is echter goed nieuws, de module om de temperatuur op te halen is klaar (we gebruiken de klasse ut de oefening van les 6: Mocking OpenWeather)
