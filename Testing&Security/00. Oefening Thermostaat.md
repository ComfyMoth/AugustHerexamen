...
<span style="color:#48cae4;">Commit Intermezzo: Reengineering of the hard-coded values</span>
...
Om het HeatingElement in de juiste status te zetten geven we een andere temperatuur in de test. Daarom moet de URL wijzigen. we maken een property van de 