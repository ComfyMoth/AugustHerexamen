...
vb. Het aantal devices (smartphones, ...) men getest. Voor het ontwerpen van goede niet-functionele testen is het vaak noodzakelijk dat de testontwerpen een grondige kennis heeft (vb. van de beveiliging zwakheden van bepaalde platformen). Hoe grondig er getest wordt kan worden uitgedrukt in structerele