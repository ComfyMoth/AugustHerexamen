...
# 2. Code debuggen
Het uivoeren van een programma in een debugger, ook wel debugging modus of foutopsporing modus genoemd, betekent dat de debugger actief alles controleert wat er gebeurt terwijl het pr