...
6. Selecteer `Unit Test Project` (.NET Core) en klik op `Next`, kies als project naam `UnitTesting.Tests` en klik op `Create` (of klik Next, selecteer .NET 6.0 en klik op Create indien nodig)